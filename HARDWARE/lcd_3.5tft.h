...
/*--------------------------------------- 常用颜色 ----------------------------------*/
//	 虽然反客2.6寸的IPS屏幕使用的颜色格式是16位的RGB565，但是这里为了方便用户使用，
...
void 	LCD_DisplayChinese(u16 x, u16 y, u8 *pText,u16 Color);	 			// 在指定坐标处显示单个汉字		
void 	LCD_DisplayText( u16 x, u16 y, u8 *pText,u16 color);				// 在指定坐标处显示文本，可显示汉字或ASCII码
